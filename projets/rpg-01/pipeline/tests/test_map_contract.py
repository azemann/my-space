...
from pipeline.tiled.tools.map_contract import validate_map
...
class MapContractTests(unittest.TestCase):
    def test_valley_satisfies_future_map_contract(self) -> None:
        errors = validate_map(ROOT / "pipeline/tiled/maps/source/vallee-des-sources.tmx")
        self.assertEqual(errors, [])

    def test_valley_visually_explains_paths_and_height_gates(self) -> None:
        root = ET.parse(ROOT / "pipeline/tiled/maps/source/vallee-des-sources.tmx").getroot()
