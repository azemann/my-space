...
const TEMPLATE := "res://pipeline/tiled/maps/templates/rpg-map-template.tmx"
...
func _initialize() -> void:
	...
	var playable := Converter._parse_tmx("res://pipeline/tiled/maps/source/vallee-des-sources.tmx")
	assert(Converter._bind_canonical_tile_set("res://pipeline/tiled/maps/source/vallee-des-sources.tmx", playable, tile_set) == OK)
	assert(Converter._validate_map("res://pipeline/tiled/maps/source/vallee-des-sources.tmx", playable, tile_set) == OK)
