...
SOURCE = ROOT / "pipeline/assets/sources/imagegen/beach/beach-terrain-source-v001.png"
...
PREVIEW = ROOT / "pipeline/assets/sources/previews/beach-terrain-preview.png"
TILE = 32
