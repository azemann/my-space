...
SOURCE = ROOT / "pipeline/assets/sources/player/generation/walk-board-rgba.png"
OUTPUT = ROOT / "pipeline/assets/sources/player/frames"
RECEIPT = ROOT / "pipeline/assets/sources/player/generation/walk-extraction.json"
