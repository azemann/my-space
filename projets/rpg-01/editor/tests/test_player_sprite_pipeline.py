...
MODULE_PATH = ROOT / "editor/sprites/build_player_sheet.py"
...
class PlayerSpritePipelineTests(unittest.TestCase):
    def test_player_provenance_required_fields_and_hashes(self) -> None:
        path = ROOT / "source-art/player/generation/provenance.json"
    ...
    def test_project_frames_match_the_player_contract(self) -> None:
        profile = json.loads((ROOT / "source-art/player/player-sprite-profile.json").read_text(encoding="utf-8"))
