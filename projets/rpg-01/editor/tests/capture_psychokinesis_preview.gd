...
const HOVER_OUTPUT := "res://source-art/previews/psychokinesis-hover-v002.png"
const HELD_OUTPUT := "res://source-art/previews/psychokinesis-held-v002.png"
const TILED_OUTPUT := "res://source-art/previews/psychokinesis-tiled-hover-v002.png"
