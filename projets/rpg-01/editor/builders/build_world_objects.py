...
SOURCES = {
    "architecture": ROOT / "source-art/imagegen/objects/architecture-props-rgba-v001.png",
    "nature": ROOT / "source-art/imagegen/objects/nature-props-rgba-v001.png",
}
...
PREVIEW = ROOT / "source-art/previews/objects_catalog.png"
TILE = 32
ATLAS = (2048, 2048)
PADDING = 5
SCALE_BY_GROUP = {
...
def main() -> int:
    ...
    metadata = {
        ...
        "normalization": {
            "authority": "group scale in editor/builders/build_world_objects.py",
            "runtime_scale": 1.0,
