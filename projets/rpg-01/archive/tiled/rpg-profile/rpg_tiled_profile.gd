...
const GENERATED_SCENES_DIRECTORY := "res://scenes/levels/generated"
const GENERATED_TILESETS_DIRECTORY := "res://resources/tilesets/generated"
const GENERATED_LEVELS_DIRECTORY := "res://resources/levels/generated"
...
static func tile_set_path(level_id: String) -> String:
	return GENERATED_TILESETS_DIRECTORY.path_join("%s.tres" % level_id)


static func level_resource_path(level_id: String) -> String:
	return GENERATED_LEVELS_DIRECTORY.path_join("%s.tres" % level_id)
